...
public interface PaymentMapper {
    ...
    @Mapping(target = "order.tableOccupancy.order", ignore = true)
    @Mapping(target = "order.tableOccupancy.reservation", ignore = true)
    ...
    @Mapping(target = "reservation.tableOccupancy.order", ignore = true)
    @Mapping(target = "reservation.tableOccupancy.reservation", ignore = true)
