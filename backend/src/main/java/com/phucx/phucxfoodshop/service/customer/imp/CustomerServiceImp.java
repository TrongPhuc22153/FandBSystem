...
import com.phucx.phucxfoodshop.model.dto.CustomerDetails;
...
public class CustomerServiceImp implements CustomerService {
    ...
    public CustomerDetail updateCustomerInfo(CustomerDetail customer) throws CustomerNotFoundException {
        ...
        if (!result)
            throw new RuntimeException("Error when update information of customer " + customer.getCustomerID());
    ...
    public CustomerDetail addNewCustomer(CustomerDetail customer) throws InvalidUserException {
        ...
        if (customer.getContactName() == null)
            throw new InvalidUserException("Missing contact name");
        if (customer.getUserID() == null)
            throw new InvalidUserException("Missing userId");
    ...
    public CustomerFullDetails getCustomerDetails(String userID) {
        ...
        String picture = customerDetail.getPicture() != null
                ? customerImageService.getImageUrl(customerDetail.getPicture())
                : null;
        ...
        CustomerDetails customerDetails = CustomerDetails.builder()
                ...
                .ward(customerDetail.getWard())
                .district(customerDetail.getDistrict())
