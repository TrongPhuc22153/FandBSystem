...
@RequestMapping(value = "/api/v1/notification/customer", produces = MediaType.APPLICATION_JSON_VALUE)
public class CustomerNotificationController {
    private final NotificationService notificationService;
    private final MarkUserNotificationService markUserNotificationService;

    @Operation(summary = "Mark notification as read", tags = { "customer", "notification",
            "post" }, description = "Update notification status")
    ...
    @Operation(summary = "Get notification summary", tags = { "customer", "notification",
            "get" }, description = "Get number of unread notifications")
    @GetMapping("/summary")
