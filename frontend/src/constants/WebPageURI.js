...
// export const FOOD_URI = '/foods'
export const ABOUT_US_URI = '/about'
...
export const CHECKOUT_ORDER_URI = '/checkout'
...
export const FORGET_PASSWORD_URI = '/auth/forget-password';
export const RESET_PASSWORD_URI = '/auth/reset-password';