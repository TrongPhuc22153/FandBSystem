...
import OrderNotificationsTable from "../components/OrderNotificationsTable";
      ...
      <div className="container-fluid p-0">
            ...
            <div className="col-sm-3" key={index}>
              <div className="card">
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-auto">
                      <div className={`stat text-primary`}>
                        <img
                          className="dashboard-icon align-middle"
                          src={stat.icon}
                        />
                      </div>
                    </div>
                  ...
                  <div className="mb-0">
                    <span className={`text-${stat.changeType}`}>
                      {stat.change}
                    </span>
        ...
        <div className="row">
          <div className="col-12 col-lg-8 col-xxl-8">
            <BarChart
              title={data.monthlySales.title}
              chartData={data.monthlySales.chartData}
            />
          </div>
          ...
          <div className="col-xl-7 col-xxl-7">
            <LineChart
              title={data.recentMovement.title}
              chartData={data.recentMovement.chartData}
            />
          </div>
