...
export function TodaySpecialDish() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      owlWrapperRef.current.style.transition =
        "transform 0.8s cubic-bezier(0.25, 1, 0.5, 1)";
      owlWrapperRef.current.style.transform = `translateX(-${
        slideIndex * slide
      }px)`;
        ...
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div className="special-box">
              <div id="owl-demo">
                <div
                  className="owl-wrapper-outer overflow-hidden"
                  ref={owlWrapperOuterRef}
                >
                  <div
                    className="owl-wrapper d-flex flex-row"
                    ref={owlWrapperRef}
                  >
