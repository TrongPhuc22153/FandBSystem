...
const items = [
    ...
    { 
        ...
        tree_branchs: [
                ...
                children: [
                    {
                        ...
                        children: [
                            { title: "Messaging", href: "/pages/product/features/messaging", children: [], active: false },
                            { title: "Voice & Video Calls", href: "/pages/product/features/voice-video-calls", children: [], active: false }
                        ],
                        active: false
                    },
                    {
                        ...
                        children: [
                            { title: "Slack", href: "/pages/product/integrations/slack", children: [], active: false },
                            { title: "Discord", href: "/pages/product/integrations/discord", children: [], active: false },
                            { title: "Microsoft Teams", href: "/pages/product/integrations/microsoft-teams", children: [], active: false },
                            { title: "Zoom", href: "/pages/product/integrations/zoom", children: [], active: true }
                        ],
                        active: false
                    },
                    { title: "Security", href: "/pages/product/security", children: [], active: false }
                ],
                active: false
            },
            {
            ...
            },
            {
                ...
                href: "/pages/blog",
                children: [
                    { title: "Newsletter", href: "/pages/blog/newsletter", children: [], active: false }
                ],
                active: false
            },
            {
                ...
                href: "/pages/company",
                children: [
                    { title: "About Us", href: "/pages/company/about-us", children: [], active: false },
                    { title: "Media & Press", href: "/pages/company/media-press", children: [], active: false },
                    { title: "Careers", href: "/pages/company/careers", children: [], active: false }
                ],
                active: false
            },
            {
    ...
    { 
        title: "Your Profile", 
        href: "/user/profile", 
        icon: <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" width="80" height="80" colors="#b2cba3,#e0df9f,#e7a83e,#9a736e,#ea525f" name="Babe Didrikson" size="80" className="avatar"><mask id="mask__beam" maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36"><rect width="36" height="36" rx="20" fill="white"></rect></mask><g mask="url(#mask__beam)" fill="transparent"><rect width="36" height="36" rx="20" fill="#e7a83e"></rect><rect x="0" y="0" width="36" height="36" transform="translate(-5 9) rotate(249 18 18) scale(1)" fill="#ea525f" rx="36"></rect><g transform="translate(-1 4.5) rotate(9 18 18)"><path d="M13,19 a1,0.75 0 0,0 10,0" fill="black"></path><rect x="10" y="14" width="1.5" height="2" rx="1" stroke="none" fill="black"></rect><rect x="24" y="14" width="1.5" height="2" rx="1" stroke="none" fill="black"></rect></g></g></svg>,
        tree_branchs: []
    }
];
    ...
    const handleLeafSelect = (leafTitle) => {
        ...
        const updatedItems = navigationItems.map(item => {
            if (item.tree_branchs.length > 0) {
                return {
                    ...item,
                    tree_branchs: activateBranch(deactivateAllBranches(item.tree_branchs), leafTitle)
                };
            }
            return item;
        });
    ...
    return (
        <>
                    ...
                    <div className="navigation-top">
                        {navigationItems.slice(0, 5).map((item, index) => (
                            <Link 
                                key={index} 
                                to={item.href} 
                                className={`navigation-item ${selectedNavigationItem === index ? 'active' : ''}`} 
                    ...
                    <div className="navigation-bottom">
                        {navigationItems.slice(5).map((item, index) => (
                            <Link 
                                key={index + 5} 
                                to={item.href} 
                                className={`navigation-item ${selectedNavigationItem === index + 5 ? 'active' : ''}`} 
            ...
            <div className="window-panel">
                ...
                <ul className="tree">
                    {navigationItems[selectedNavigationItem].tree_branchs.map((branch, index) => (
                                    ...
                                    {branch.children.map((subBranch, subIndex) => (
                                        <li key={subIndex} className="tree-branch tree-branch--sub">
                                            ...
                                            {subBranch.children.length > 0 && (
                                                <ul className="tree tree--sub">
                                                    {subBranch.children.map((subSubBranch, subSubIndex) => (
