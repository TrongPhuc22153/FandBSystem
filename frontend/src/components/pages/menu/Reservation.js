...
export default function ReservationComponent() {
    ...
    return (
        <>
            ...
            <div id="reservation" className="reservations-main container pad-top-100 pad-bottom-100">
                <div className="container">
                    <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 px-3">
                                        <div className="form-box">
                                            <select
                                                ...
                                                onChange={handleChange}
                                            >
                                                <option value="" disabled>No. Of persons</option>
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 px-3">
                                        <div className="form-box">
                                            <select
                                                ...
                                                onChange={handleChange}
                                            >
                                                <option value="" disabled>preferred food</option>
