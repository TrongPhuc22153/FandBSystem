...
export default function CartComponent() {
    ...
    return (
        <div className="container px-4 py-5 panel-margin-top">
            ...
            {cartItems.map((item) => (
                <div key={item.id} className="row d-flex justify-content-center border-top">
                    <div className="col-5">
                    ...
                    <div className="my-auto col-7">
                        <div className="row text-right">
                            <div className="col-3">
                                <p className="mob-text d-flex align-items-center">{item.category}</p>
                            </div>
                            <div className="col-3">
                                <div className="h-100 d-flex justify-content-end px-3">
                                    <p className="mb-0 me-2 d-flex align-items-center ">{item.quantity}</p>
                                    <div className="d-flex flex-column plus-minus">
                                        <span className="vsm-text plus btn" onClick={() => handleIncreaseQuantity(item.id)}>+</span>
                                        <span className="vsm-text minus btn" onClick={() => handleDecreaseQuantity(item.id)}>-</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-4">
